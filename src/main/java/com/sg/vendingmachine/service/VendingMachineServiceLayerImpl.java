...
public class VendingMachineServiceLayerImpl implements 
    ...
    public VendingMachineServiceLayerImpl(VendingMachineDao dao, 
                VendingMachineAuditDao auditDao, Change change) {
       this.dao = dao;
    ...
    public String purchaseItem(String itemNumber, BigDecimal deposit) throws
        ...
        String stringChange = change.getDollars() 
                + " dollars, " + change.getQuarters()+ " quarters, " 
                + change.getDimes()+ " dimes, " + change.getNickels() 
                + " nickels, and " + change.getPennies()+ " pennies.";
